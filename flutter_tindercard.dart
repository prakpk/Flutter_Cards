...
//  double _minHeight;
  ...
  @override
  _TinderSwapCardState createState() => _TinderSwapCardState(mycurrentFront:currentFront );
...
class _TinderSwapCardState extends State<TinderSwapCard>
  ...
  _TinderSwapCardState({
    @required this.mycurrentFront,
});
...
//    _currentFront=2;
    ...
    _animationController.addStatusListener((AnimationStatus status) {
      int index = widget._totalNum - widget._stackNum - _currentFront-1;
      if (status == AnimationStatus.completed) {
        if (frontCardAlign.y < widget._swipeEdge &&
            frontCardAlign.y > -widget._swipeEdge) {
